...
class Add_Pokemon(Global):
    ...
    def page2(self):
        ...
        self.img_pokemon("Phanpy",'images/images-add/add_pokemon6.png',100,119,150,240)
        ...
        self.img_pokemon("Rondoudou",'images/images-add/add_pokemon8.png',90,109,150,483)
